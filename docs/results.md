...
![Malimg deep-model accuracy: paper versus our saved run](images/deep-malimg.png)

![Malimg reported time: paper versus our training and evaluation](images/time-malimg.png)
...
![BIG2015 deep-model accuracy: paper versus our saved run](images/deep-big2015.png)

![BIG2015 reported time: paper versus our training and evaluation](images/time-big2015.png)
...
![MaleVis deep-model accuracy: paper versus our saved run](images/deep-malevis.png)

![MaleVis reported time: paper versus our training and evaluation](images/time-malevis.png)
...
![Blended deep-model accuracy: paper versus our saved run](images/deep-blended.png)

![Blended reported time: paper versus our training and evaluation](images/time-blended.png)
...
![MaleVis without Other ConvNet accuracy: paper versus our saved run](images/deep-malevis-without-other.png)

![MaleVis without Other reported time: paper versus our training and evaluation](images/time-malevis-without-other.png)
...
![Malimg GLCM accuracy: paper, raw, and balanced-augmented results](images/glcm-malimg.png)
...
![BIG2015 GLCM accuracy: paper, raw, and balanced-augmented results](images/glcm-big2015.png)
...
![MaleVis GLCM accuracy: paper, raw, and balanced-augmented results](images/glcm-malevis.png)
...
![Blended GLCM accuracy: paper, raw, and balanced-augmented results](images/glcm-blended.png)
